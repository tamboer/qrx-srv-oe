...
procedure getInstance:
   ...
   case className:
      when 'Request':u then
         classInstance = com.quarix.web.Request:GetInstance().
      when 'Response':u then
         classInstance = com.quarix.web.Response:GetInstance().
   end case.
   &else
   case className:
      when 'Request':u then
         classInstance = new com.quarix.web.Request().
      when 'Response':u then
         classInstance = new com.quarix.web.Response().
   end case.
   &endif
end procedure.
