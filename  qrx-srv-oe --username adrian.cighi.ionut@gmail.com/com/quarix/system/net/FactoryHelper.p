...
procedure getInstance:
   ...
   case className:
      when 'ApplicationServer':u then
         classInstance = com.quarix.system.net.ApplicationServer:GetInstance().
   end case.
   &else
   case className:
      when 'ApplicationServer':u then
         classInstance = new com.quarix.system.net.ApplicationServer().
   end case.
   &endif
end procedure.
