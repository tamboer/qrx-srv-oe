...
procedure getInstance:
   ...
   case className:
      when 'Array':u then
         classInstance = new com.quarix.base.Array().
      when 'Collection':u then
         classInstance = new com.quarix.base.Collection().
      when 'Util':u then
         classInstance = new com.quarix.base.Util().
      when 'Proxy':u then
         classInstance = new com.quarix.base.Proxy().
   end case.
end procedure.
